...
module top;
	import "DPI-C" function void svPutLogicArrElemVecValFunction(output logic [7:0] data[], input  int index, input logic[7:0] value);
	logic [7:0] arr[0:7];
	logic [7:0] arr2 [0:7];
	initial 
	begin
		svPutLogicArrElemVecValFunction(arr, 3, 8'hFA);
		svPutLogicArrElemVecValFunction(arr2, 5, 8'hAB);
