...
module top;
	import "DPI-C" function void svPutLogicArrElemFunction(inout logic [7:0] data[], input int index, input byte unsigned value);

	logic [7:0] arr[0:7];

	initial
	begin
		svPutLogicArrElemFunction(arr, 3, 8'hAA);
		svPutLogicArrElemFunction(arr, 6, 8'h55);
